...
## ===== the openglobus version is contained in the package.json file
...
## in the file names rollup.config.js, suppress terser in the 1st plugin before the json() pluginn
