...
from airlines.models import Airline, AirlineCosts, AirlineAircraft, AirlineRoute
    ...
    if airline:
        ...
        for airlineAircraft in AirlineAircraft.objects.filter(airline=airline):
            ...
            for airlineRoute in AirlineRoute.objects.filter(airline=airline):
                ...
                firstAirlineCosts = AirlineCosts.objects.all().filter(airline=airline, airlineAircraft=airlineAircraft, airlineRoute=airlineRoute).first()
                if firstAirlineCosts:
